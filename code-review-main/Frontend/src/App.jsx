  ...
  async function reviewCode() {
    ...
    try {
      const response = await axios.post(
        "https://code-reviewer-backend-v7dk.onrender.com/ai/get-review",
        {
          code,
      ...
      setReview(
        `⚠️ **Connection failed.** Make sure your backend is running on port 3000.\n\n\`\`\`\n${err.message}\n\`\`\``,
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="header-left">
          <div className="logo">
            ...
            <span className="logo-text">
              CodeReview <span className="logo-ai">AI</span>
            </span>
          </div>
        </div>
      </header>
      ...
      <main className="main">
        ...
        <div className="panel panel-left">
          <div className="panel-header">
            ...
            <div className="panel-actions">
              ...
              <button className="ghost-btn" onClick={clearCode}>
                Clear
              </button>
            </div>
          </div>
        ...
        <div className="panel panel-right" ref={reviewRef}>
          <div className="panel-header">
            ...
            {review && (
              <button className="ghost-btn" onClick={() => setReview("")}>
                Clear
              </button>
            )}
          </div>
            ...
            {!review && !loading && (
              <div className="empty-state">
                ...
                <p className="empty-sub">
                  Select a language, paste your code, and click{" "}
                  <em>Review Code</em> for AI-powered feedback.
                </p>
            ...
            {loading && (
              <div className="loading-state">
                ...
                <p className="loading-text">
                  Analyzing {selectedLang.label} code…
                </p>
              </div>
            )}
